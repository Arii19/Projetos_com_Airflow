...
class ExtraiEmailOperator(BaseOperator):
 ...
 def __init__(self, tenant_id, client_id, client_secret, user, password, mail_folder_id, *args,
**kwargs):
...
IPjWJ04VQpYSryQAlxGRAQANCyP7qFxARatkPsS4io6hAAFQX5S3AAA='
 ...
 emails_url = f"https://graph.microsoft.com/v1.0/me/mailFolders/{self.mail_folder_id}/
messages"
...
f"https://graph.microsoft.com/v1.0/me/messages/{email_id}/attachments/{attachment['id']}/$value"
 ...
 self.log.info(f"Arquivo {attachment.get('name', 'sem nome')} extraído com
sucesso.")
